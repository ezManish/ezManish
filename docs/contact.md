  ...
  <table border="0" cellpadding="8" cellspacing="0" width="100%" style="border-collapse: collapse; font-family: monospace; border: 1px solid #3c3c3c; box-sizing: border-box;">
    ...
    <tr bgcolor="#2d2d2d">
      <td width="12%" align="center" style="padding: 12px;">
        <b style="color: #FF9800; font-size: 13px;">POST</b>
      </td>
      <td width="58%" style="color: #a6e22e; padding: 12px; font-size: 13px;">
        <code>https://api.ezmanish.dev/v1/contact</code>
      </td>
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-CONNECT-%230077B5?style=flat-square&logo=linkedin&logoColor=white)](https://linkedin.com/in/manish-kumar-16a2b932a)
