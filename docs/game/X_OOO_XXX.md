  ...
  <table border="0" cellpadding="8" cellspacing="0" width="100%" style="border-collapse: collapse; font-family: monospace; border: 1px solid #3c3c3c; box-sizing: border-box;">
    ...
    <tr bgcolor="#2d2d2d">
      ...
      <td width="20%" align="center" style="color: #4CAF50; padding: 12px; font-size: 12px; font-weight: bold;">
        <code>Status: 200 OK (Payload: User Won)</code>
      </td>
    </tr>
    <!-- Navigation Tabs -->
    <tr bgcolor="#252526">
...
<div align="center">
  <h3 style="color: #4CAF50;">CONGRATULATIONS! YOU DEFEATED THE API BOT!</h3>
  <p>Response: User solved the state machine. Code: 200.</p>
  <a href="../play-game.md"><b>[ Play Again (Send New Request) ]</b></a>
</div>
