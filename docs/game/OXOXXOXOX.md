<div align="center">
  <table border="0" cellpadding="8" cellspacing="0" width="100%" style="border-collapse: collapse; font-family: monospace; border: 1px solid #3c3c3c; box-sizing: border-box;">
    ...
    <tr bgcolor="#2d2d2d">
      ...
      <td width="20%" align="center" style="color: #ffeb3b; padding: 12px; font-size: 12px; font-weight: bold;">
        <code>Status: 204 No Content (Tie)</code>
      </td>
    </tr>
    <!-- Navigation Tabs -->
    <tr bgcolor="#252526">
...
<div align="center">
  <h3 style="color: #ffeb3b;">DRAW. SYSTEM BALANCED.</h3>
  <p>Response: Conflict resolved. Code: 204.</p>
  <a href="../play-game.md"><b>[ Play Again (Reconnect) ]</b></a>
</div>
