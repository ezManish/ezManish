<div align="center">
  <table border="0" cellpadding="8" cellspacing="0" width="100%" style="border-collapse: collapse; font-family: monospace; border: 1px solid #3c3c3c; box-sizing: border-box;">
    ...
    <tr bgcolor="#2d2d2d">
      ...
      <td width="20%" align="center" style="color: #f44336; padding: 12px; font-size: 12px; font-weight: bold;">
        <code>Status: 500 Internal Server Error (Bot Won)</code>
      </td>
    </tr>
    <!-- Navigation Tabs -->
    <tr bgcolor="#252526">
...
<div align="center">
  <table border="0" cellpadding="0" cellspacing="6" style="border-collapse: separate; border-spacing: 6px; font-family: monospace; text-align: center; margin: 20px auto;">
    ...
    <tr>
      <td align="center" valign="middle" width="60" height="60" bgcolor="#222222" style="border: 1px solid #3c3c3c; border-radius: 6px;"><span style="color: #ff6c37; font-size: 22px; font-weight: bold; line-height: 60px; display: block;">X</span></td>
      <td align="center" valign="middle" width="60" height="60" bgcolor="#222222" style="border: 1px solid #3c3c3c; border-radius: 6px;"><span style="color: #ff6c37; font-size: 22px; font-weight: bold; line-height: 60px; display: block;">X</span></td>
      <td align="center" valign="middle" width="60" height="60" bgcolor="#222222" style="border: 1px solid #3c3c3c; border-radius: 6px;"><span style="color: #444444; font-size: 18px; line-height: 60px; display: block;">[ ]</span></td>
    </tr>
  </table>
</div>
...
<div align="center">
  <h3 style="color: #f44336;">SERVER ERROR: BOT DEFEATED YOU.</h3>
  <p>Response: StackOverflow occurred. Code: 500.</p>
  <a href="../play-game.md"><b>[ Play Again (Reset Server) ]</b></a>
</div>
